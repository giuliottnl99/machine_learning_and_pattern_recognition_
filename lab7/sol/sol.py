...
if __name__ == '__main__':
    ...
    commedia_ll = numpy.load('lab7/data/commedia_ll.npy')
    commedia_labels = numpy.load('lab7/data/commedia_labels.npy')
    ...
    print()
    print("Binary task")
    commedia_llr_binary = numpy.load('lab7/data/commedia_llr_infpar.npy')
    commedia_labels_binary = numpy.load('lab7/data/commedia_labels_infpar.npy')
    ...
    commedia_llr_binary = numpy.load('lab7/data/commedia_llr_infpar_eps1.npy')
    commedia_labels_binary = numpy.load('lab7/data/commedia_labels_infpar_eps1.npy')
    ...
    print()
    print('Eps 1.0')
    commedia_ll = numpy.load('lab7/data/commedia_ll_eps1.npy')
    commedia_labels = numpy.load('lab7/data/commedia_labels_eps1.npy')
