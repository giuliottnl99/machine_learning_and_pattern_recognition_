...
def loadScoresKernelPoly(DT, LT, DV, path, isQuadratic=False):
    i=0
...
if __name__ == "__main__":
    ...
    # loadScoresKernelPoly(DTQuadratic, LT, DVQuadratic, "lab9/exam/save/kernelPoly_quadratic/", isQuadratic=True) #almost sure to delete with all the saving folders
